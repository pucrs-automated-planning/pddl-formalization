...
Graphplan available with the <span><span
style="font-variant:small-caps;">[JavaGP](http://sourceforge.net/projects/emplan/)</span></span> library[1].
...
-   three files containing the problems you formalised, named
    `pb\sigma`, where `\sigma` is the sequential number of your
    problem, e.g. `pb1.pddl`, `pb2.pddl`;

-   the same number of files (with similar names) showing the traces
    created by <span><span
    style="font-variant:small-caps;">[JavaGP](http://sourceforge.net/projects/emplan/)</span></span> for
    the problems you created (e.g. `pb1.pddl` and `pb1.txt`); and
...
in Figures \[fig:fig\_pfile1\] through \[fig:fig\_pfile3\], any
...
![Problem 1<span data-label="fig:fig_pfile1"></span>](fig/pfile1.png)

![Problem 2<span data-label="fig:fig_pfile2"></span>](fig/pfile2.png)

![Problem 3<span data-label="fig:fig_pfile3"></span>](fig/pfile3.png)
...
website[2]. The report must have the following sections:
...
-   Two domain formalisation sections explaining your approach to
    formalising the problems from Section \[sec:problems\]

-   One experimentation section where the performance of <span><span
    style="font-variant:small-caps;">[JavaGP](http://sourceforge.net/projects/emplan/)</span></span> is
...
-   One conclusion section, where you will summarise your experience in
    encoding planning domains and discuss the performance of <span><span
    style="font-variant:small-caps;">[JavaGP](http://sourceforge.net/projects/emplan/)</span></span>,
...
-   Domain Encoding (30%) — correctness of the domain encoding, in
    relation to the domain specification from Section \[sec:overview\];

-   Problem specifications (20%) — correctness of the problem
    specifications used for the experiments, particularly the initial
    state specification, as missing predicates here will jeopardise
    <span><span
    style="font-variant:small-caps;">[JavaGP](http://sourceforge.net/projects/emplan/)</span></span>’s
...
-   Experiments (30%) — how coherent the proposed experiments are in
    measuring the performance of <span><span
    style="font-variant:small-caps;">[JavaGP](http://sourceforge.net/projects/emplan/)</span></span>,
...
We have provided two template PDDL files at [Domain
Template](https://github.com/pucrs-automated-planning/pddl-formalization/blob/master/pddl/domain-template.pddl)
and [Problem
Template](https://github.com/pucrs-automated-planning/pddl-formalization/blob/master/pddl/problem-template.pddl)
to get you started, these were obtained from the
[myPDDL](https://github.com/Pold87/myPDDL) sublime package. We have also
...
-   [Blocks World
    Domain](http://moodle.pucrs.br/mod/resource/view.php?id=720129)

-   [Gripper
    domain](http://moodle.pucrs.br/mod/resource/view.php?id=729356)
...
-   <span><span
    style="font-variant:small-caps;">[JavaGP](http://sourceforge.net/projects/emplan/)</span></span> does
    not parse “or” conditions or effects. You need to specify conditions
...
[1] <http://sourceforge.net/projects/emplan/>

[2] <http://goo.gl/OxC9H5>

[3] GnuPlot is an excellent (and free) graph making software, available
